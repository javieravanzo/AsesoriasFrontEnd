...
BankRefunded.propTypes = {
  bankRefundedResponse: PropTypes.array,
};

const mapStateToProps = (state) => {
  return {
    bankRefundedResponse: state.admin.bankRefundedResponse,
  }
};

const mapDispatchToProps = (dispatch) => {
  return {
    getAllBankRefunded: () => dispatch(getAllBankRefunded()),
  }
};

export default connect(mapStateToProps, mapDispatchToProps)(BankRefunded);
