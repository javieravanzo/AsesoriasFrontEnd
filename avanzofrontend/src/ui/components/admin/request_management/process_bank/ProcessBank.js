...
//Actions
import { getAllProcessForBank } from "../../../../../store/redux/actions/admin/adminActions";
...
class DefinitelyRejected extends Component {
  ...
  constructor (props) {
    ...
    this.props.getAllProcessForBank();
  ...
  render(){
    ...
    let {idRequest, identificationId, requestStateName, quantity, createdAt} = this.state;
    let tableData = this.setData(this.props.processInBank);
    //console.log("JSON", this.props.definitelyRejected);
    
    if(this.props.processInBank === null){
...
DefinitelyRejected.propTypes = {
  processInBank: PropTypes.array,
};

const mapStateToProps = (state) => {
  return {
    processInBank: state.admin.processInBank,
  }
};

const mapDispatchToProps = (dispatch) => {
  return {
    getAllProcessForBank: () => dispatch(getAllProcessForBank()),
  }
};
