...
import {Col, Row, Tooltip, Icon, Divider, Badge, Button, Modal, Form, Select} from 'antd';
        ...
        <Badge count={defineBadgeName(item.requestStateId)} style={{backgroundColor: defineButtonClass(item.idRequestState), color: "black"} }>
          ...
          
          {
            ...
            <div>
              ...
              <br/><br/>
              <Row gutter={4}>
                <Col xs={24} sm={12} md={15} lg={13} className={"document-col"}>
