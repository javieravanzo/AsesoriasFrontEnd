...
//Actions
import {getAllProcessDocumentsChange} from "../../../../../store/redux/actions/admin/adminActions";

//Styles
import '../../../../styles/admin/request_management/request-state.css';
import { SUCCESS_MODAL } from '../../../subcomponents/modalMessages';

class DocumentsChange extends Component {
  ...
  constructor (props) {
    ...
    this.props.getAllProcessDocumentsChange();
  ...
  render(){
    ...
    let {idRequest, identificationId, requestStateName, quantity, createdDate} = this.state;
    let tableData = this.setData(this.props.processDocumentsChangeReponse);
    //console.log("JSON", tableData, JSON.stringify(tableData));
    
    if(this.props.processDocumentsChangeReponse === null){
...
DocumentsChange.propTypes = {
  processDocumentsChangeReponse: PropTypes.array,
};

const mapStateToProps = (state) => {
  return {
    processDocumentsChangeReponse: state.admin.processDocumentsChangeReponse,
  }
};

const mapDispatchToProps = (dispatch) => {
  return {
    getAllProcessDocumentsChange: () => dispatch(getAllProcessDocumentsChange()),
  }
};

export default connect(mapStateToProps, mapDispatchToProps)(DocumentsChange);
