...
//Actions
import { getAllDefinitelyRejected } from "../../../../../store/redux/actions/admin/adminActions";

//Styles
import '../../../../styles/admin/request_management/request-state.css';
import { SUCCESS_MODAL } from '../../../subcomponents/modalMessages';

class DefinitelyRejected extends Component {
  ...
  constructor (props) {
    ...
    this.props.getAllDefinitelyRejected();
  ...
  render(){
    ...
    let {idRequest, identificationId, requestStateName, quantity, createdDate} = this.state;
    let tableData = this.setData(this.props.definitelyRejected);
    //console.log("JSON", this.props.definitelyRejected);
    
    if(this.props.definitelyRejected === null){
...
DefinitelyRejected.propTypes = {
  definitelyRejected: PropTypes.array,
};

const mapStateToProps = (state) => {
  return {
    definitelyRejected: state.admin.definitelyRejected,
  }
};

const mapDispatchToProps = (dispatch) => {
  return {
    getAllDefinitelyRejected: () => dispatch(getAllDefinitelyRejected()),
  }
};

export default connect(mapStateToProps, mapDispatchToProps)(DefinitelyRejected);
