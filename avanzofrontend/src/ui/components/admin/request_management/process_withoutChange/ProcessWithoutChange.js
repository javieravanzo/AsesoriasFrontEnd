...
//Actions
import {getAllProcessWithoutChange} from "../../../../../store/redux/actions/admin/adminActions";

//Styles
import '../../../../styles/admin/request_management/request-state.css';
import { SUCCESS_MODAL } from '../../../subcomponents/modalMessages';

class ProcessWithoutChanges extends Component {
  ...
  constructor (props) {
    ...
    this.props.getAllProcessWithoutChange();
...
ProcessWithoutChanges.propTypes = {
  processWithoutChangeReponse: PropTypes.array,
};

const mapStateToProps = (state) => {
  return {
    processWithoutChangeReponse: state.admin.processWithoutChangeReponse,
  }
};

const mapDispatchToProps = (dispatch) => {
  return {
    getAllProcessWithoutChange: () => dispatch(getAllProcessWithoutChange()),
  }
};

export default connect(mapStateToProps, mapDispatchToProps)(ProcessWithoutChanges);
