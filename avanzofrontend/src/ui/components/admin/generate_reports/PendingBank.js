...
//Actions
import {generatePendingByBankReport, receiveBankFile} from "../../../../store/redux/actions/admin/adminActions";
...
class PendingBank extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if(nextProps.pendingToFinalizeByBank !== null){
      return {
        reportData: seeDocument(nextProps.pendingToFinalizeByBank, BaseURL),
      };
  ...
  sendReport = () => {
    this.props.generatePendingByBankReport();
  };
...
PendingBank.propTypes = {
  pendingToFinalizeByBank: PropTypes.string,
  receiveBankFileCode: PropTypes.string,
};

const mapStateToProps = (state) => {
  return {
    pendingToFinalizeByBank: state.admin.pendingToFinalizeByBank,
...
const mapDispatchToProps = (dispatch) => {
  return {
    generatePendingByBankReport: ( ) => dispatch(generatePendingByBankReport( )),
    receiveBankFile: (data) => dispatch(receiveBankFile(data))
  }
};

export default connect(mapStateToProps, mapDispatchToProps)(PendingBank);
